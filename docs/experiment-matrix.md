...
| D07 | Gated full-page `R32G32B32A32_UINT` to BC3 reinterpret conversion for six observed shapes; commit `833cafa0…` | [installed; run 1 prepared](evidence-d07-preparation.md) | Confirm square source format and test 4x interiors plus borders in one exact-class behavioral run | pending runtime test |
