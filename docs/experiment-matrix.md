...
| D03 | Placed-resource heap ranges and alias-barrier correlation at local commit `cfca234e…` | [custom tool and run prepared](evidence-d03-preparation.md) | Determine whether D02's 433 no-upload SRV resources overlap live buffers/textures or participate in explicit alias barriers | inconclusive |
