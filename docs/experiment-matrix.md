...
| D02 | Ordinary texture, mip-view, and upload-copy census | instrumentation pending | Identify stable texture classes and streaming operations for focused correlation | inconclusive |
