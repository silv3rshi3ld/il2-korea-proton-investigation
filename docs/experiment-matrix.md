...
| D12 | Named reflection-resource usage, barrier, draw/shader, and submission telemetry; commit `e7f6e303…` | installed and run prepared locally | Determine which D11 targets are rendered or transitioned and bind them to stable shader hashes and submissions | diagnostic only; awaiting run |
