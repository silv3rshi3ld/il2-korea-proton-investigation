...
| D14 | Upstream `VKD3D_SHADER_DUMP_PATH` capture of the four stable light-grid compute hashes and three correlated reflection-stage hashes | [prepared](evidence-d14-shader-dump-preparation.md) | Inspect exact DXIL/SPIR-V thread-group coverage, resource dimension/type, and 3D integer addressing without replacing shaders | diagnostic only; awaiting short menu dump |
