...
| E03 | `VKD3D_DISABLE_EXTENSIONS=VK_EXT_descriptor_buffer` | prepared | not run | — | — | — | — | — | — | inconclusive | Selected after D03 excluded placed-resource range aliasing; test only this variable |
