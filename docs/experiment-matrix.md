...
| D13 | Focused `rtLightRefs`/self-light/light-volume barrier, clear, dispatch/draw shader, and submission telemetry; commit `395d9747…` | [built locally](evidence-d13-light-grid-trace-preparation.md) | Test the 80x34x2 `R32_UINT` light-reference grid that maps the 2560x1080 frame into approximately 32x32-pixel tiles | diagnostic only; not installed or run |
