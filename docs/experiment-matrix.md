...
| D11 | Bounded resource-name and PIX pass-label telemetry; commit `d3cba21d…` | [installed and run prepared](evidence-d11-menu-pass-trace-preparation.md) | Same main-menu aircraft for at least 30 seconds; valid `IL2MENU` enable markers; classify supplied reflection/SSR names and pass labels | diagnostic only; awaiting run |
