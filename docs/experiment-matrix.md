...
| D05c | Exact observed `R32G32B32A32_UINT` footprint to BC3 reinterpret mapping; commit `5391ec7f…` | [completed](evidence-d05c-result.md) | 202/202 candidates adjusted, zero rejected, eight destinations; missing pages and magenta edges remain | unchanged; copy class excluded as primary visible cause |
| D06 | Focused producer-to-SRV trace for 2048x2048 one-mip baked-terrain caches and associated intermediates; commit `376652dc…` | [installed; run 1 prepared](evidence-d06-preparation.md) | Correlate page creation, copies, barriers/layouts, SRV creation, and destruction without changing commands | pending runtime trace |
